...
from paddleseg3d.transforms import get_moreDA_augmentation, default_2D_augmentation_params, default_3D_augmentation_params
from paddleseg3d.datasets import MedicalDataset
import json
from paddleseg3d.datasets import DataLoader2D, DataLoader3D
from paddleseg3d.transforms.nnunet_transform import *
...
class MSDDataset(MedicalDataset):
    ...
    def __getitem__(self, idx):
        ...
        # data_dict = next(self.gen)
        # data, label = data_dict['data'], data_dict['target']
        # data = data[0]
        # labels = []
        # for l in label:
        #     labels.append(l[0])
    ...
    def process_plans(self, plans):
        ...
        # self.batch_size = 1
        # self.batch_size_ = stage_plans['batch_size']
