...
def restore_model(pkl_file, checkpoint=None, train=False, fp16=None):
    ...
    init = info['init']
    name = info['name']
    search_in = join(medicalseg.core.__path__[0], "training", "network_training")
    tr = recursive_find_python_class([search_in], name, current_module="medicalseg.core.training.network_training")
