...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        self.network: Tuple[SegmentationNetwork, paddle.DataParallel] = None
        self.optimizer = None
    ...
    def load_checkpoint_ram(self, checkpoint, train=True):
        ...
        self.network.set_state_dict(new_state_dict)
        ...
        if train:
            ...
            if self.lr_scheduler is not None and hasattr(self.lr_scheduler, 'load_state_dict') and checkpoint[
                ...
                self.lr_scheduler.set_state_dict(checkpoint['lr_scheduler_state_dict'])

            if issubclass(self.lr_scheduler.__class__, LRScheduler):
    ...
    def maybe_update_lr(self):
        ...
        if self.lr_scheduler is not None:
            assert isinstance(self.lr_scheduler, (paddle.optimizer.lr.ReduceOnPlateau, paddle.optimizer.lr.LRScheduler))
