...
import argparse
from tools.preprocess_utils.preprocessing.preprocessing import resample_data_or_seg
from tools.batchgenerators.utilities.file_and_folder_operations import maybe_mkdir_p
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(medicalseg.core.__path__[0], "training", "network_training")],
                                                trainerclass,
