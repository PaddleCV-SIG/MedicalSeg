...
class DC_and_CE_loss(nn.Layer):
    def __init__(self, batch_dice=True, smooth=1e-5, do_bg=False, ce_kwargs={}, reduction="sum", square_dice=False, weight_ce=1, weight_dice=1,
    ...
    def forward(self, net_output, target):
        ...
        if self.reduction == "sum":
            ...
            raise NotImplementedError("reduction type not support, only support 'sum'.") 
