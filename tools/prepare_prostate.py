...
class Prep_luna(Prep):
    ...
    def convert_path(self):
        ...
        self.load_save(
            ...
            self.label_path,
            preprocess=[
                functools.partial(resample, new_shape=[128, 128, 64], order=0)
            ],
            valid_suffix='mhd',
    ...
    def generate_txt(self):
        ...
        self.split_files_txt(
            txtname[0], image_files, label_files, train_split=45)
        self.split_files_txt(
            txtname[1], image_files, label_files, train_split=45)
